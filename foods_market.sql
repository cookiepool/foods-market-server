...
INSERT INTO fm_products VALUES(
	1, '鲜 文蛤 30-40只/500g（称重）', '新鲜美味，口感上佳', 15.90, '500g', 'http://referenceerror.top/imgs/products_detail/detail_1.jpg', 1, 4
);
INSERT INTO fm_products VALUES(
	2, '波士顿龙虾（只）', '产自加拿大优质海域，肉质紧实，原汁原味', 119.00, '只', 'http://referenceerror.top/imgs/products_detail/detail_2.jpg', 1, 2
);
INSERT INTO fm_products VALUES(
	3, '鲜 蛏子 20-25只/500g（称重）', '体大肥美 鲜香嫩滑，美味之选', 59.90, '500g', 'http://referenceerror.top/imgs/products_detail/detail_3.jpg', 1, 4
);
INSERT INTO fm_products VALUES(
	4, '东星斑600-800g/条（称重）', '肉厚刺少，海鲜美味', 298.00, '500g', 'http://referenceerror.top/imgs/products_detail/detail_4.jpg', 1, 1
);
INSERT INTO fm_products VALUES(
	5, '鲜活海螺100-200g/只（称重）', '破海而出的鲜活美味，肥美无比', 49.90, '500g', 'http://referenceerror.top/imgs/products_detail/detail_5.jpg', 1, 4
);
INSERT INTO fm_products VALUES(
	6, '鲜活花螺（称重）', '洁净海域滋养的花螺，活力旺盛，鲜肥饱满', 79.90, '500g', 'http://referenceerror.top/imgs/products_detail/detail_6.jpg', 1, 4
);
INSERT INTO fm_products VALUES(
	7, '鲜活鲍鱼', '六七头鲍 海中珍品 色泽鲜艳 海味之冠 餐桌黄金 圆润饱满', 2.20, '只', 'http://referenceerror.top/imgs/products_detail/detail_7.jpg', 1, 4
);
INSERT INTO fm_products VALUES(
	8, '鲜活江团（600-750g/条）', '新鲜捕捞，入口细嫩', 29.90, '条', 'http://referenceerror.top/imgs/products_detail/detail_8.jpg', 1, 1
);
INSERT INTO fm_products VALUES(
	9, '鲜活小龙虾30-39g/只（称重）', '清水白肚 源头直采 新鲜直达', 24.90, '500g', 'http://referenceerror.top/imgs/products_detail/detail_9.jpg', 1, 2
);
INSERT INTO fm_products VALUES(
	10, '鲜 鲈鱼 500-700g/条（称重）', '肉质晶莹剔透，品质优异，肉质鲜嫩可口', 25.80, '500g', 'http://referenceerror.top/imgs/products_detail/detail_10.jpg', 1, 1
);
# 冷冻大类：2；子类：猪：1，鸭：2，鱼：3，虾：4，鹅：5
INSERT INTO fm_products VALUES(
	11, '猪蹄/500g（称重）', '带筋猪蹄，脂肪含量比肥肉底', 60.90, '500g', 'http://referenceerror.top/imgs/products_detail/detail_11.jpg', 2, 1
);
INSERT INTO fm_products VALUES(
	12, '鸭掌/500g（称重）', '谷物喂养，卤制经典食材', 25.90, '500g', 'http://referenceerror.top/imgs/products_detail/detail_12.jpg', 2, 2
);
INSERT INTO fm_products VALUES(
	13, '鳕鱼/500g（称重）', '源自洁净深海的海中美味，味道鲜美，肉质嫩滑，营养美味', 281.90, '500g', 'http://referenceerror.top/imgs/products_detail/detail_13.jpg', 2, 3
);
INSERT INTO fm_products VALUES(
	14, '黑虎虾/500g（称重）', '肉质饱满，虾肉肥美', 9.90, '500g', 'http://referenceerror.top/imgs/products_detail/detail_14.jpg', 2, 4
);
INSERT INTO fm_products VALUES(
	15, '鹅肠/500g（称重）', '肉质饱满，香嫩可口', 39.90, '500g', 'http://referenceerror.top/imgs/products_detail/detail_15.jpg', 2, 5
);
...
# 蔬菜水果：4，子类：蔬菜：1，水果：2
INSERT INTO fm_products VALUES(
	18, '法香/50g', '新鲜的法香，气味浓郁清香', 3.50, '份', 'http://referenceerror.top/imgs/products_detail/detail_18.jpg', 4, 1
);
# 鲜花野味：5，子类：鲜花：1，野味：2
INSERT INTO fm_products VALUES(
	19, '兰花/50g', '新鲜的兰花，美丽诱人', 19.50, '份', 'http://referenceerror.top/imgs/products_detail/detail_19.jpg', 5, 1
);
INSERT INTO fm_products VALUES(
	20, '野鸭', '野味，营养又好吃，滋阴补肾', 1999.90, '只', 'http://referenceerror.top/imgs/products_detail/detail_20.jpg', 5, 2
);
# 珍品：6，子类：1
INSERT INTO fm_products VALUES(
	21, '茶钩翅', '绝对巴适的拌', 2999.50, '份', 'http://referenceerror.top/imgs/products_detail/detail_21.jpg', 6, 1
);
INSERT INTO fm_products VALUES(
	22, '燕窝', '滋阴补肾，绝对大补', 9999.90, '500g', 'http://referenceerror.top/imgs/products_detail/detail_22.jpg', 6, 1
);
